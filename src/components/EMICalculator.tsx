...
return (
  // Updated padding: py-6 for mobile to reduce top spacing, lg:py-20 for desktop
  <section className="py-6 bg-gradient-to-br from-[#e71c23] to-[#af1d30] text-white">
    <div className="container mx-auto px-4">
      {/* Updated gap: gap-6 for mobile to reduce spacing, lg:gap-12 for desktop */}
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-1 lg:gap-12 items-center">
        
        {/* Left Side - Content */}
        <ScrollAnimation direction="right">
          <div>
            {/* --- EMI Calculator Badge (Visible on Mobile & Desktop) --- */}
            ...
            {/* --- Headings & Description (Hidden on Mobile) --- */}
            ...
            {/* --- DESKTOP BUTTON --- Commented out as requested */}
      ...
      {/* --- MOBILE BUTTON --- Commented out as requested */}
